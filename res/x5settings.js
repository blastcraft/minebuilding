...
x5engine.imQueue.push_init("x5engine.imMenu.setup({ target: '#imMnMn', verticalScroll: false, orientation: 'vertical', menuHeight: 30, submenuHeight: 21, opacity: 0.800, type: 'singleColumn', effect: 'fade'})",false);
